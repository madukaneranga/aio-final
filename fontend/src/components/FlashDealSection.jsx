...
const FlashDealsBanner = ({ 
  ...
  products = [
    ...
    {
      id: 2,
      image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=200&h=150&fit=crop", 
  ...
  useEffect(() => {
    const now = new Date();
    const saleStartTime = new Date(now.getTime() + 
      (saleStartsInHours * 60 * 60 * 1000) + 
      (saleStartsInMinutes * 60 * 1000) +
      (saleStartsInSeconds * 1000)
    );
    const saleEndTime = new Date(saleStartTime.getTime() + 
  ...
  }, [saleStartsInHours, saleStartsInMinutes, saleStartsInSeconds, saleEndsInHours, saleEndsInMinutes, saleEndsInSeconds]);
  ...
  return (
    <section className="py-12 lg:py-16 relative overflow-hidden" style={backgroundStyle}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          {/* LEFT SIDE - Content */}
          <div className="flex-1 text-center lg:text-left" style={{ color: textColor }}>
            
            {/* Timer Badge */}
            <div className="inline-flex items-center gap-3 bg-black/30 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <div className="text-3xl lg:text-5xl font-black mb-6" style={{ color: accentColor }}>
              {discountText}
            ...
            {/* CTA Button */}
            <button className="bg-white text-black font-bold text-lg px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-xl hover:scale-105 flex items-center gap-3 mx-auto lg:mx-0">
              {buttonText}
