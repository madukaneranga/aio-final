...
export const walletAPI = {
  ...
  getTransactions: async (params = {}) => {
    ...
    const response = await fetch(`${API_BASE_URL}/wallet/transactions?${queryString}`, {
      headers: getAuthHeaders()
    });
    return handleResponse(response);
  },
  ...
  getBankDetails: async () => {
    const response = await fetch(`${API_BASE_URL}/wallet/bank-details`, {
      headers: getAuthHeaders()
    });
    return handleResponse(response);
  },
...
export const adminAPI = {
  getPendingWithdrawals: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    const response = await fetch(`${API_BASE_URL}/admin/withdrawals/pending?${queryString}`, {
      headers: getAuthHeaders()
    });
    return handleResponse(response);
  },
  ...
  getAllWithdrawals: async (params = {}) => {
    const queryString = new URLSearchParams(params).toString();
    const response = await fetch(`${API_BASE_URL}/admin/withdrawals?${queryString}`, {
      headers: getAuthHeaders()
    });
    return handleResponse(response);
  },
