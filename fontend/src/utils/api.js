...
export const api = {
  ...
  // User endpoints
  users: {
    getAll: (params = "") => fetch(`${API_BASE_URL}/api/users?${params}`),
  ...
  // Store endpoints
  stores: {
    getAll: (params = "") => fetch(`${API_BASE_URL}/api/stores?${params}`),

    getById: (id) => fetch(`${API_BASE_URL}/api/stores/${id}`),
    ...
    getFeatured: () => fetch(`${API_BASE_URL}/api/stores/featured/list`),
  },

  // Product endpoints
  products: {
    getAll: (params = "") => fetch(`${API_BASE_URL}/api/products?${params}`),

    getById: (id) => fetch(`${API_BASE_URL}/api/products/${id}`),
  ...
  // Service endpoints
  services: {
    getAll: (params = "") => fetch(`${API_BASE_URL}/api/services?${params}`),

    getById: (id) => fetch(`${API_BASE_URL}/api/services/${id}`),
